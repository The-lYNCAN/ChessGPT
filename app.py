...
def predict(request: PredictionRequest):
    ...
    # Replace this with your transformer inference
    output_tokens = generate(model, token_to_id, id_to_token, [token_to_id[i] for i in input_tokens], 1, device, temperature=0.2)
